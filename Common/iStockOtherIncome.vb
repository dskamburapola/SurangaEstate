            ...
            Using DR As IDataReader = DB.ExecuteReader(DBC)
                ...
                With DR
                    Do While .Read
                        ...
                        Me.Amount = IIf(Not IsDBNull(.Item("Amount")), Trim(.Item("Amount").ToString), "0")
                        Me.Rate = IIf(Not IsDBNull(.Item("Rate")), Trim(.Item("Rate").ToString), "0")
                        Me.Quantity = IIf(Not IsDBNull(.Item("Quantity")), Trim(.Item("Quantity").ToString), "0")
