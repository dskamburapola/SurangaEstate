...
#Region "Monthly Expenses"
    ...
    Function GetMonthlyExpenses() As DataSet

        Dim DB As Database = DatabaseFactory.CreateDatabase(ISTOCK_DBCONNECTION_STRING)
        Dim DBC As DbCommand = DB.GetStoredProcCommand("MonthlyExpenses")
...
#Region "Monthly Income"
    ...
    Function GetMonthlyIncome() As DataSet
        ...
        DB.AddInParameter(DBC, "@OtherIncomeDate", DbType.Date, Me.FromDate)
