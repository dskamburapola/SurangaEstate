    ...
    Private Sub sbGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sbGenerate.Click
        ...
        If dxvpMonthlyReport.Validate Then
            ...
            If dt1.Rows.Count > 0 Then
                ...
                '    cell7.Size = New Size(report.xrMainTable.Rows(0).Cells(1).WidthF, 25)
                '    cell2.Size = New Size(report.xrMainTable.Rows(0).Cells(2).WidthF, 25)
                '    cell3.Size = New Size(report.xrMainTable.Rows(0).Cells(3).WidthF, 25)
                '    cell4.Size = New Size(report.xrMainTable.Rows(0).Cells(4).WidthF, 25)
                '    cell5.Size = New Size(report.xrMainTable.Rows(0).Cells(5).WidthF, 25)
                '    cell6.Size = New Size(report.xrMainTable.Rows(0).Cells(6).WidthF, 25)
            ...
            If dt4.Rows.Count > 0 Then
                ...
                If IsDBNull(dt4.Rows(0).Item("KPB")) Then
                    report.xrMainTable.Rows(4).Cells("r5c5").Text = "0.00 "
                Else
                    report.xrMainTable.Rows(4).Cells("r5c5").Text = FormatNumber(CStr((dt4.Rows(0).Item("KPB"))), 2, TriState.True) & " "
                    StaffSalaryTotal = Convert.ToDecimal(dt4.Rows(0).Item("KPB").ToString())
            ...
            Dim uu As New DevExpress.XtraReports.UI.XRControl
            Dim xx As New DevExpress.XtraReports.UI.XRTable
            Dim yy As New DevExpress.XtraReports.UI.XRTableCell
            Dim yy1 As New DevExpress.XtraReports.UI.XRTableCell
            Dim ii As New DevExpress.XtraReports.UI.XRTableRow

            yy.Size = New Size(100, 25)
            yy.Text = "ddfdf bsdfsdsf"
            yy.BackColor = Color.AntiqueWhite

            yy1.Text = "sdfsffasfsfsfs"
            ...
            uu.Controls.Add(xx)
            xx.HeightF = 100
            report.xrMainTable.Rows(9).Cells("rcash").Controls.Add(uu)
            ...
            'cellEmpty1.Size = New Size(report.xrMainTableheader.Rows(0).Cells(0).WidthF, 25)
            'cellEmpty2.Size = New Size(report.xrMainTableheader.Rows(0).Cells(1).WidthF, 25)
            'cellEmpty3.Size = New Size(report.xrMainTableheader.Rows(0).Cells(2).WidthF, 25)
            'cellEmpty4.Size = New Size(report.xrMainTableheader.Rows(0).Cells(3).WidthF, 25)
            'cellEmpty5.Size = New Size(report.xrMainTableheader.Rows(0).Cells(4).WidthF, 25)
            'cellEmpty6.Size = New Size(report.xrMainTableheader.Rows(0).Cells(5).WidthF, 25)
            ...
            'report.xrMainTableheader.Rows.Add(trEmpty)
                ...
                If dt10.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt10.Rows.Count - 1
                        ...
                        cellE1.Size = New Size(report.xrMainTableheader.WidthF, 10)
                        cellE1.Text = " "
                        trE1.Cells.Add(cellE1)
                        report.xrMainTableheader.Rows.Add(trE1)
